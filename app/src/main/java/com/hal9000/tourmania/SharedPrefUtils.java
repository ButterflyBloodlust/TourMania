...
public class SharedPrefUtils {
    ...
    private static final String ALIAS = "km1x92IozP43l";
    ...
    public static void putEncryptedString(Context context, String key, String value) {
        ...
        if (value == null) {
            ...
            try {
                prefs.edit().putString(key, encryptString(context, value)).apply();
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public static String getDecryptedString(@NonNull Context context, String key) {
        ...
        if (!TextUtils.isEmpty(pref)) {
            return decryptString(context, pref);
        }
    ...
    public static void generateKeys(Context context) {
        try {
            ...
            Log.w(TAG, "Generating keys failed...");
            e.printStackTrace();
        }
    }
