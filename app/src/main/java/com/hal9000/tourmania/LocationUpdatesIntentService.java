            ...
            if (intent != null) {
                ...
                if (ACTION_PROCESS_UPDATES.equals(action)) {
                    ...
                    if (result != null) {
                        ...
                        LocationServiceUtils.setLocationUpdatesResult(this, locations);
                        LocationServiceUtils.sendNotification(this, LocationServiceUtils.getLocationResultTitle(this, locations));
                        Log.d("crashTest", LocationServiceUtils.getLocationUpdatesResult(this));
                    }
                }
            }
        } catch (Exception e) {
